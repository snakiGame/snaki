...
import { COMBO_THRESHOLD, COMBO_TIMEOUT, SCORE_MULTIPLIERS } from '../lib/gameConstants';
...
export const useComboSystem = () => {
  ...
  const calculateScore = useCallback((baseScore: number, combo: number, powerUpType: PowerUp | null) => {
